var htmx = function () {
  ...
  function h(e, t) {
    const n = e instanceof Element &&
      (e.matches || e.matchesSelector || e.msMatchesSelector ||
        e.mozMatchesSelector || e.webkitMatchesSelector || e.oMatchesSelector);
    return !!n && n.call(e, t);
  }
  function T(e) {
    const t = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i;
  ...
  function P(e) {
    ...
    if (n === "html") {
      ...
      const i = q(
        '<body><template class="internal-htmx-wrapper">' + t +
          "</template></body>",
      );
  ...
  function f(e) {
    return e instanceof Element || e instanceof Document ||
  ...
  function $e(e, t, r, o) {
    ...
    if (s.elt && !le(s.elt) && ee(s.elt, "id")) {
      ...
      const p = {
        preventScroll: r.focusScroll !== undefined
          ? !r.focusScroll
  ...
  function tt(e, t, n) {
    return Ge.exec(e.charAt(0)) && e !== "true" && e !== "false" &&
      e !== "this" && e !== n && t !== ".";
  }
  function nt(r, o, i) {
    if (o[0] === "[") {
  ...
  function ut(e) {
    return location.hostname === e.hostname && ee(e, "href") &&
      ee(e, "href").indexOf("#") !== 0;
  }
  function at(e) {
  ...
  function ft(t, n, e) {
    if (
      t instanceof HTMLAnchorElement && ut(t) &&
  ...
  function dt(e, t) {
    return ie(e).boosted && e instanceof HTMLAnchorElement &&
      t.type === "click" && (t.ctrlKey || t.metaKey);
  }
  function gt(e, t, n) {
  ...
  function Et(e) {
    ...
    for (let e = 0; e < n.length; e++) {
      const r = n[e].name;
      if (
        l(r, "hx-on:") || l(r, "data-hx-on:") || l(r, "hx-on-") ||
        l(r, "data-hx-on-")
      ) return true;
    }
    return false;
  ...
  function Gt(o) {
    ...
    e.onload = function () {
      if (this.status >= 200 && this.status < 400) {
        ...
        const t = e.querySelector("[hx-history-elt],[data-hx-history-elt]") ||
          e;
        const n = Ut();
        const r = xn(n);
        kn(e.title);
  ...
  function bn(r, e, o, i) {
    ...
    if (s) {
      ...
      for (const l in n) {
        if (n.hasOwnProperty(l)) { if (i[l] == null) i[l] = n[l]; }
      }
    }
  ...
  function Rn(t, n, r) {
    ...
    if (r) {
      if (r instanceof Element || typeof r === "string") {
        ...
        let e = y(r.target);
        if (r.target && !e || r.source && !e && !y(r.source)) e = ve;
  ...
  function de(t, n, r, o, i, D) {
    ...
    const C = {
      ...
      verb: t,
      errors: b,
      withCredentials: i.credentials || S.credentials ||
  ...
  function Dn(o, i) {
    ...
    if (m.shouldSwap) {
      ...
      if (
        t && he(o, "htmx:beforeTransition", i) &&
    ...
    if (f) {
      fe(
        ...
        "htmx:responseError",
        ce({
          error: "Response Status Error Code " + s.status + " from " +
  ...
  function _n() {
    if (Q.config.includeIndicatorStyles !== false) {
      ...
      ne().head.insertAdjacentHTML(
        "beforeend",
        "<style" + e + ">      ." + Q.config.indicatorClass +
          "{opacity:0}      ." + Q.config.requestClass + " ." +
